...
var OBJDoc = function (fileName) {
  ...
  OBJDoc.prototype.getDrawingInfo = function () {
    ...
    var textures = new Float32Array(this.textures.length*2);
    // jump here
    ...
    for (var i = 0; i < this.objects.length; i++) {
      ...
      for (var j = 0; j < object.faces.length; j++) {
        ...
        for (var k = 0; k < face.vIndices.length; k++) {
          ...
          if (tIdx >= 0) {
            // console.log("im in the ifstatement");
            // console.log("before");
            var texCoord = this.textures[tIdx];
            // console.log(texCoord.u);
            // console.log(texCoord.v);
            
            textures[vIdx * 2 + 0] = texCoord.u;
            textures[vIdx * 2 + 1] = texCoord.v;
            // console.log("after");
            // console.log(textures[vIdx * 2 + 0]);
            // console.log(textures[vIdx * 2 + 1]);
          }
          index_indices++;
        }
      }
